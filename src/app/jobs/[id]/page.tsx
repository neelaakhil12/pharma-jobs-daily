  ...
  return (
    <div className="bg-[#F8FAFC] min-h-screen py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div
          data-aos="fade-up"
          className="bg-gradient-to-tr from-white via-green-50/20 to-emerald-50/10 rounded-3xl p-8 border border-white shadow-md mb-8 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative overflow-hidden"
        >
          ...
          <div className="lg:col-span-8 space-y-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-base font-bold text-[#059669]">{job.company}</p>
            </div>
            <div className="flex flex-wrap gap-4 text-xs font-semibold text-slate-500">
              <span className="flex items-center gap-1.5"><MapPin className="w-4 h-4 text-green-600" /> {job.location}</span>
              <span className="flex items-center gap-1.5"><Calendar className="w-4 h-4 text-emerald-500" /> Posted on {formattedDate}</span>
            </div>
          </div>
          <div className="lg:col-span-4 flex flex-col sm:flex-row lg:flex-col gap-3 justify-end items-stretch lg:items-end w-full">
            <a
              href={job.applyUrl}
              className="px-6 py-3 text-center text-xs font-extrabold text-white bg-gradient-to-r from-[#16A34A] to-[#10B981] hover:bg-right bg-[size:200%_auto] rounded-xl shadow-lg transition-all duration-300 transform hover:-translate-y-0.5"
            >
              Apply Now
            </a>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8 space-y-8" data-aos="fade-right">
            ...
            {job.responsibilities && job.responsibilities.length > 0 && (
              <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-md space-y-4">
                <h2 className="text-lg font-bold text-slate-855 border-b border-slate-100 pb-3 flex items-center gap-2">
                  <span className="w-1.5 h-6 rounded-full bg-[#10B981] shrink-0" />
            ...
            {job.requirements && job.requirements.length > 0 && (
              <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-md space-y-4">
                <h2 className="text-lg font-bold text-slate-855 border-b border-slate-100 pb-3 flex items-center gap-2">
                  <span className="w-1.5 h-6 rounded-full bg-[#059669] shrink-0" />
                  Key Requirements & Skills
                </h2>
                <ul className="space-y-3.5">
                  {job.requirements.map((req, idx) => (
                    <li key={idx} className="flex items-start gap-3">
                      <AlertTriangle className="w-5 h-5 text-[#059669] shrink-0 mt-0.5" />
              ...
              <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-md space-y-4">
                ...
                <ul className="space-y-3.5">
                  {job.benefits.map((ben, idx) => (
                    <li key={idx} className="flex items-start gap-3">
                      <span className="w-5 h-5 rounded-full bg-green-50 text-[#16A34A] flex items-center justify-center shrink-0 font-extrabold text-xs mt-0.5">•</span>
          ...
          <aside className="lg:col-span-4 space-y-8" data-aos="fade-left">
            ...
            <div className="bg-gradient-to-br from-green-50/70 via-emerald-50/45 to-teal-50/70 rounded-3xl p-6 border border-white/60 shadow-lg space-y-4 backdrop-blur-md">
            ...
            <div className="bg-green-50/50 border border-green-200/50 rounded-3xl p-6 space-y-3.5 shadow-sm">
              <div className="flex items-center gap-2 text-green-700 font-extrabold text-sm">
                <ShieldCheck className="w-5 h-5" />
                Anti-Fraud Safety Notice
              </div>
              <p className="text-green-900/80 text-[11px] leading-relaxed">
