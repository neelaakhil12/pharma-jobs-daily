...
export default function SocialChannelsPopup() {
  ...
  return (
    ...
    >
      ...
      {/* Modal Card */}
      <div
        className={`relative w-full max-w-md bg-white rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.3)] border border-slate-100 overflow-hidden transform transition-all duration-500 ease-out ${
        ...
        <div className="p-6 sm:p-8 space-y-6">
          ...
          <div className="space-y-3.5">
            ...
            <a
              ...
              rel="noopener noreferrer"
              onClick={handleDismiss}
              className="flex items-center justify-between p-4 bg-sky-50 hover:bg-sky-100/80 border border-sky-100 hover:border-sky-300 rounded-2xl transition-all duration-300 group shadow-sm hover:shadow-md cursor-pointer hover:-translate-y-0.5"
            >
              <div className="flex items-center gap-3.5">
                <div className="p-2.5 bg-[#0088cc] text-white rounded-xl shadow-md shadow-sky-500/20 group-hover:scale-105 transition-transform duration-300">
                  <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                  <span className="block text-slate-800 font-extrabold text-sm group-hover:text-sky-600 transition-colors">Telegram Channel</span>
                  <span className="block text-[11px] text-slate-500 font-medium">Join updates discussion</span>
                </div>
              </div>
              <ExternalLink className="w-4 h-4 text-sky-400 group-hover:text-sky-600 group-hover:translate-x-0.5 transition-all" />
            </a>
            ...
            <a
              ...
              rel="noopener noreferrer"
              onClick={handleDismiss}
              className="flex items-center justify-between p-4 bg-pink-50 hover:bg-pink-100/80 border border-pink-100 hover:border-pink-300 rounded-2xl transition-all duration-300 group shadow-sm hover:shadow-md cursor-pointer hover:-translate-y-0.5"
            >
              <div className="flex items-center gap-3.5">
                <div className="p-2.5 bg-gradient-to-tr from-[#833ab4] via-[#fd1d1d] to-[#fcb045] text-white rounded-xl shadow-md shadow-pink-500/20 group-hover:scale-105 transition-transform duration-300">
                  <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                  <span className="block text-slate-800 font-extrabold text-sm group-hover:text-pink-600 transition-colors">Instagram Page</span>
                  <span className="block text-[11px] text-slate-500 font-medium">Follow daily highlights</span>
                </div>
              </div>
              <ExternalLink className="w-4 h-4 text-pink-400 group-hover:text-pink-600 group-hover:translate-x-0.5 transition-all" />
            </a>
          </div>
          ...
          <div className="text-center pt-2">
            <button
              onClick={handleDismiss}
              className="text-xs text-slate-450 hover:text-slate-700 font-bold transition-colors cursor-pointer select-none"
            >
              Maybe Later
            </button>
          </div>
