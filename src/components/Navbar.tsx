      ...
      <nav className="sticky top-0 z-50 bg-[#00469b] border-b border-white/10 shadow-md transition-all duration-300">
          ...
          <div className="flex justify-between items-center py-2.5">
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              <a
                ...
                className="p-2.5 text-white bg-[#FF0000] hover:bg-[#cc0000] rounded-xl shadow-md hover:shadow-red-500/20 transition-all duration-300 transform hover:-translate-y-0.5 flex items-center justify-center cursor-pointer"
              >
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        >
          <div className="bg-[#00469b] border-t border-white/10 px-4 py-4 space-y-1">
            ...
            <div className="grid grid-cols-5 gap-2 pt-2 border-t border-slate-100/50 mt-2">
              {/* WhatsApp */}
              <a
                href={socialLinks.whatsapp}
                target="_blank"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex flex-col items-center justify-center gap-1.5 py-2.5 rounded-2xl bg-red-50 border border-red-100 hover:bg-red-100/60 transition-all text-[10px] font-bold text-red-600 cursor-pointer"
              >
