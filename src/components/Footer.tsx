        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3.5 text-sm">
              <li>
                <Link href="/" className="hover:text-green-400 transition-colors duration-200 block py-0.5">
                  Home Dashboard
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/contact" className="hover:text-green-400 transition-colors duration-200 block py-0.5">
                  Get in Touch
                </Link>
              </li>
              <li>
                <Link href="/adminlogin" className="hover:text-green-400 transition-colors duration-200 block py-0.5 text-xs text-neutral-500">
                  Administrator Area
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-6">
            <h3 className="text-lg font-bold text-white relative inline-block">
              Instant Alerts
              <span className="absolute bottom-0 left-0 w-8 h-0.5 bg-green-500 rounded" />
            </h3>
            <p className="text-sm leading-relaxed text-neutral-400">
            ...
            <form className="flex gap-2" onSubmit={(e) => e.preventDefault()}>
              <input
                ...
                required
                className="w-full px-4 py-2.5 bg-neutral-900 border border-neutral-850 rounded-xl text-sm text-white focus:outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500 placeholder-neutral-500 transition-colors"
              />
              <button
                type="submit"
