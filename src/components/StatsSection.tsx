...
const stats = [
  { label: 'Total Jobs Posted', value: 15000, suffix: '+', icon: FileCheck, col: 'from-green-500 to-emerald-600' },
  { label: 'Active Job Seekers', value: 50000, suffix: '+', icon: Users, col: 'from-orange-500 to-amber-600' },
  { label: 'Recruitment Partners', value: 320, suffix: '+', icon: Building, col: 'from-purple-500 to-indigo-600' },
  { label: 'Years of Trusted Service', value: 6, suffix: '+ Years', icon: Award, col: 'from-green-500 to-orange-500' },
];
