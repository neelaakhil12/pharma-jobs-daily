...
export default function QuickApplyForm({ jobTitle, applyUrl }: QuickApplyFormProps) {
  ...
  if (submitted) {
    return (
      <div className="p-8 text-center bg-white border border-green-200 rounded-3xl shadow-lg space-y-4 animate-zoom-in">
        <div className="w-16 h-16 bg-green-50 text-[#16A34A] rounded-full flex items-center justify-center mx-auto shadow-sm">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-1">
          ...
          <input
            ...
            className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-700 focus:outline-none focus:border-[#16A34A] placeholder-slate-450"
            disabled={submitting}
          />
        </div>
        ...
        <div className="space-y-1">
          ...
          <textarea
            ...
            className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-700 focus:outline-none focus:border-[#16A34A] placeholder-slate-450 resize-none"
            disabled={submitting}
          />
        </div>
