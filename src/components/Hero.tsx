          ...
          <div className="lg:col-span-7 space-y-8" data-aos="fade-right">
            ...
            <div className="grid grid-cols-2 gap-2 items-center">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="col-span-2 group flex items-center justify-center gap-1.5 sm:gap-1.5 px-2.5 sm:px-4 py-2 sm:py-2.5 bg-red-50 border border-red-100 hover:bg-red-100/60 transition-all font-bold text-red-600 rounded-full cursor-pointer shadow-sm hover:shadow-md w-full min-w-0 overflow-hidden"
              >
